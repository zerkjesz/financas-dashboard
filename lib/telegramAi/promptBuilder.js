...
- Você recebe uma lista de contas/cartões REAIS existentes — use os nomes EXATOS deles nos campos "account"/"card" quando identificar qual é. Se a mensagem não deixar claro qual conta/cartão, deixe o campo vazio (não adivinhe silenciosamente).
