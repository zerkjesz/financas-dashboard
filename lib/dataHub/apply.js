...
// Fase 6.1 (Incident P0) — o padrão do Prisma pra transação interativa é
// timeout:5000ms. A causa raiz do incidente foi O(n) round-trips de
// matching dentro da transação (corrigido em adapters.js/plan.js), mas o
// apply em si ainda faz 1 create/update POR LINHA nova/alterada (necessário
// pra capturar o preimage de cada uma, pro undo real de 24h) — margem
// generosa aqui é defesa em profundidade, não a correção principal.
export const IMPORT_TRANSACTION_OPTIONS = { timeout: 30000, maxWait: 10000 };
