...
export async function buildFinancialSummary({ accounts: accountsIn, cards: cardsIn, projection30: projection30In } = {}) {
  ...
  // Fonte única de "dinheiro livre" (exclui VA) — lib/freeMoney.js. Antes essa conta
  // era refeita aqui, em indicators.js e (de forma diferente, incluindo VA por engano)
  // em cashFlowProjection.js. Ver AUDITORIA, achado P0-4.
