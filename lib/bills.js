...
export async function createBill({ description, amount, category, accountId, dueDate, recurringRuleId, cycleMonth, notes, source, confidence, rawMessage }) {
...
export async function markBillPaid(billId, { accountId, occurredAt, description, confidence } = {}) {
