...
export const NAV_ITEMS = [
  ...
  // Fase 5.4F.1 — "Metas & Indicadores" corrigido pra "Metas": a Fase 5.4F
  // removeu IndicadoresView/lib/indicators.js (vocabulário V1) de /metas,
  // que agora só mostra Goals — o label ficou stale, prometendo uma
  // surface que não existe mais. Fonte única (este array) alimenta as 3
  // superfícies visíveis (NavBar desktop 7-item, MoreDropdown 768-1023px,
  // MobileNav More sheet <768px) — corrigido uma vez só aqui.
  { key: "metas", label: "Metas", mobileLabel: "Metas", href: "/metas", icon: Target, mobilePriority: false },
];
