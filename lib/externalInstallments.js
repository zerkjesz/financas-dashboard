...
// mesmo installmentValue, dueDate espaçada em meses a partir de firstDueDate) numa
// única prisma.$transaction — nunca fica um Plan sem parcelas se algo falhar no
// meio. NUNCA cria um Card falso pra representar isso.
export async function createExternalInstallmentPlan({
  ...
  if (!firstDueDate) throw new Error("firstDueDate é obrigatória");
