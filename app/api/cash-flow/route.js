...
import { buildBaseProjection, buildExpectedProjection, buildStressProjection, HORIZON_OPTIONS } from "@/lib/financialProjection";
...
// collectOutflowEvents). lib/cashFlowProjection.js foi REMOVIDO na Fase
// 5.4F (zero caller real restante — FluxoCaixaView.jsx, o único consumer
// deste shape de resposta, também foi removido: sua rota /fluxo-caixa já
// era um redirect puro pra /fluxo desde a Fase 5.4D, o arquivo tinha ficado
// órfão).
//
...
// esperado/cenário de pressão lado a lado).
